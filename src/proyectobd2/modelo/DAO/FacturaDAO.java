...
public class FacturaDAO {
    ...
    public static List<Object[]> obtenerEntradas(int idSucursal) {
        List<Object[]> listaFilas = new ArrayList<>();
        String statement = "SELECT folio, fechaFactura AS fecha, proveedor, rfc, total FROM entradasView WHERE sucursal = ?";
    ...
    public static List<Object[]> obtenerEntradasGlobales() {
        List<Object[]> listaFilas = new ArrayList<>();
        String statement = "SELECT v.folio, v.fechaFactura AS fecha, v.proveedor, v.rfc, v.total, s.nombreSucursal FROM entradasView v JOIN sucursal s ON v.sucursal = s.idSucursal";
